...
Notice the difference? All "modern" technology is capitalised and all "old" technology is in lower case. Each "modern" product is the One and Only, and each "old" product is only one of many. This has become so accepted that we now expect technology to come to us by brand names rather than generic descriptors. Where we used to have room for umbrella terms that describe many implementations of the same technology, our modern brains only have room for one. And when brand names take the place of generic categories, they adopt their orthography and grammatical function. We no longer go to the App Store, but to the app store. No more Whatsapp groups, only whatsapp groups. No more searching the web, only googling.
